...
export default function ContactSection() {
  ...
  const contactInfo = [
    {
      icon: Mail,
      value: "anandpatle2005@gmail.com",
      href: "anandpatle2005@gmail.com",
      copyable: true,
    },
    { icon: Phone, value: "+91 7489424529", href: "tel:+917489424529" },
    {
      icon: MapPin,
      value: "Bhopal, Mp",
      href: "",
  ...
  const socialLinks = [
    {
      icon: Github,
      url: "https://github.com/anandpatle330-web",
      color: "hover:text-gray-900 dark:hover:text-white",
    },
    {
      icon: Linkedin,
      url: "https://www.linkedin.com/in/anand-patle-634b30259/",
      color: "hover:text-blue-600",
    },
    {
      icon: Code2,
      url: "https://leetcode.com/u/anand_patle/",
