...
export default function FooterSection() {
  ...
  const socialLinks = [
    { icon: Github, url: "https://github.com/anandpatle330-web", label: "GitHub" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/anand-patle-634b30259/", label: "LinkedIn" },
    { icon: Instagram, url: "", label: "Instagram" },
    { icon: Mail, url: "anandpatle2005@gmail.com", label: "Email" },
  ];
  ...
  return (
    ...
    >
      ...
      <p className={`text-center md:text-lg font-semibold text-center  ${isDarkMode ? "text-gray-400" : "text-gray-800"}`}>
           Anand Patle. Built with React & Framer Motion
      </p>
    </footer>
  );
}
