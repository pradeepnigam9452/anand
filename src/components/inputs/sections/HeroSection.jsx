...
import Resume from '../../../Anand_Resume.pdf'
        ...
        <div className="max-w-7xl mx-auto w-full z-10 mt-20">
          ...
          <div className="block lg:hidden">
            ...
            >
              ...
              >
                I’m <span className="text-blue-500">Anand Patle</span>
              </motion.div>
              ...
              >
                {[
                  ...
                  {
                    icon: FiLinkedin,
                    href: "https://github.com/anandpatle330-web",
                  },
          ...
          <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            >
              ...
              >
                I’m <span className="font-bold">Anand Patle</span>
              </motion.div>
              ...
              >
                {[
                  { icon: FiGithub, href: "https://github.com/anandpatle330-web" },
                  {
                    icon: FiLinkedin,
                    href: "https://www.linkedin.com/in/anand-patle-634b30259/",
                  },
                  { icon: Mail, href: "mailto: anandpatle2005@gmail.com" },
                ].map((social, i) => (
                  <motion.a
                    key={i}
                    href={social.href}
